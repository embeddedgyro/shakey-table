...
For the cad design a [OpenSCAD](https://openscad.org/) was used. OpenSCAD is an open source parametric CAD program. It is good for customisable designs. In the cad directory you can see the design file for the shakey table including the wheel lid and frame.
